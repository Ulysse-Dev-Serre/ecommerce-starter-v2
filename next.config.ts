...
const securityHeaders = [
  ...
  },
  {
    ...
    value:
      "default-src 'self'; " +
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://js.stripe.com https://maps.googleapis.com https://*.googleapis.com https://*.clerk.accounts.dev https://clerk.com https://*.clerk.com https://va.vercel-scripts.com https://*.googletagmanager.com https://*.google-analytics.com; " +
