    ...
    <div className={`space-y-4 ${compact ? 'space-y-2' : ''}`}>
      ...
      >
        ...
        <button
          ...
          disabled={disabled || isAddingToCart || isBuyingNow}
          className={`flex items-center justify-center gap-2 bg-black hover:bg-gray-800 text-white px-6 py-3 rounded-lg font-medium cursor-pointer disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors ${compact ? 'text-sm px-4 py-2' : ''} ${compact ? 'w-full' : 'flex-1'}`}
        >
